    ...
    <section className="py-16 bg-white flex flex-col md:flex-row items-center md:justify-between mt-32">
      ...
      <div className="mt-8 md:mt-0 relative">
        <img
          src={About_img}
          alt="Nail Salon"
          className=" w-[1300px] h-auto object-cover cursor-pointer"
      ...
      <div className="max-w-4xl mx-auto px-6">
        <h2 className="text-7xl mb-4 leading-snug tracking-wide">
        ...
        <ul className="text-gray-600 list-disc list-inside mb-6 max-w-2xl">
